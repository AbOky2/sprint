...
import { getNewPropertiesApiMethod, addBookmarkApiMethod } from '../../lib/api/customer';
...
const PropertyPage = ({ id, user, property = {}, properties = [], isLocation = false }) => {
      ...
      <div>
        ...
        <Grid container alignItems="flex-start">
          ...
          <Grid item md={4} className={classes.extraInfo}>
            ...
            {isLocation ? (
              <div className={classes.extraInfoLocation}>
                <Typography variant="h3">Frais à prévoir :</Typography>
                <Typography>
                  Honoraires d’organisation de la visite + Constitution du dossier + Rédaction du
                  bail à la charge du locataire :
                </Typography>
                <Typography>
                  Honoraires de réalisation d'état des lieux à la charge du locataire :
                  <strong>188€ TTC</strong>
                </Typography>
                <Typography>
                  Dépot de garantie : 
{' '}
