      ...
      <div>
        ...
        >
          ...
          >
            <div
              ...
              style={{ top: '-83%' }}
            >
              <div className=" bg-white rounded-full w-9 h-9 py-2 px-1.5">
                <Icon
                  type="heart"
                  size="large"
              ...
              <div className=" bg-white rounded-full w-9 h-9 py-1.5 px-1 justify-between mx-2">
                <Icon type="partageV2" noColor />
              </div>
            </div>
          </Grid>
        </div>
          ...
          <Grid item md={6}>
            <div className="mb-5">
              {isLocation ? (
                ...
                <p
                  className="text-[48px] text-left text-blue-500 font-bold text-3xl"
                  style={{
                    color:
            ...
            <div className="m-2 border-4 border-r-0 border-t-0 border-b-0 border-_rougeStudea mt-9">
              ...
              {isLocation ? (
                <p className="text-2xl font-medium text-left text-_rougeStudea mx-4">
                  à partir de
                  {` ${spaceCurrency(property.price)}€ CC/mois`}{' '}
                </p>
              ) : (
            ...
            <div className=" w-96">
              {isLocation ? (
                <div className="flex justify-center items-center w-[343px] relative gap-2.5 px-[120px] py-4 rounded-xl bg-_rougeStudea">
                  <AnchorLink
                    href="#table"
                    className="flex-grow-0 flex-shrink-0 text-sm font-bold text-left text-white font-_spaceGrotesk"
                  >
                    Déposer mon dossier
                  </AnchorLink>
                </div>
        ...
        >
          ...
          <p className="self-stretch flex-grow-0 flex-shrink-0  w-_295 text-sm font-medium text-left text-white">
            Kit le nid aime bien faire des prouts dans les logements, et ça
            tombe bien parce que il y a un piano livré avec l’appartement ! À
            vous les gateaux aux chocolats mmmm !
          </p>
        </div>
