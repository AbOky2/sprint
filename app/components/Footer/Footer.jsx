      ...
      <div className="container">
        <div className="row justify-content-between">
          <div className="col-12 col-md-4 col-lg-5">
            ...
            >
              *Mensualité donnée à titre indicatif uniquement, pour l’achat d’un
              appartement de 190 000 €, sur une base de durée de 25 ans, à un
              taux d’intérêt fixe de 1.4%, incluant un Prêt à Taux Zéro de 60
              000€ et avec un apport personnel de 5 000 €.
            </p>
          </div>
